 ...
 * **Personal Attribute**. We define _personal attribute_ to be an individual as a whole, or the presence or absence of any individual characteristic, including but not limited to age, body modifications, ethnic origin, gender, gender-expression, gender-orientation, intellectual disability, nationality, physical appearance, physical disability, presented appearance, race, sex, sexual preferences, sexual-orientation, size, skin color, socio-economic status, and strength; attitudes, beliefs, moral systems, personality traits, political views, religions, and values; facts, including address, experience, job title, membership in categories or groups, membership in communities, current and past professions, real name, salary, and type and extent of education.
