 ...
 * **Personal Attribute**. We define _personal attribute_ to be an individual as a whole, or the presence or absence of any individual characteristic, including but not limited to age, biological sex, body modifications, body size or shape, ethnic origin, gender identity, gender expression, gender orientation, intellectual disability, nationality, physical appearance, physical disability, physical strength, presented appearance, race, sexual preferences (including preferences for BDSM or kink), sexual-orientation, skin color, and socio-economic status; attitudes, beliefs, moral systems, personality traits, political views, religions, and values; facts, whether current or past, including address, lifestyle choices, experience, job title, membership in categories, groups, or communities, real name, salary, and type and extent of education.
