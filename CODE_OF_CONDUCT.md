 ...
 * **Destructive Individual**. We define _destructive individuals_ to be any individuals that we intentionally label destructive, and for whom one or more of the following hold:
 ...
 * **Personal Attribute**. We define _personal attribute_ to be an individual as a whole, or the presence or absence of any individual characteristic, including but not limited to age, body modifications, ethnic origin, gender, gender-expression, gender-orientation, intellectual disability, physical appearance, physical disability, presented appearance, race, sex, sexual preferences, sexual-orientation, size, skin color, and strength; attitudes, beliefs, moral systems, personality traits, political views, religions, and values; facts, including address, job title, membership in categories or groups, membership in communities, current and past professions, real name, salary, and type and extent of education.
 ...
 * **Unprofessional Conduct**. We define _unprofessional conduct_ to be any _conduct_ that qualifies as _harassing_, _prying_, or _insulting_ for individuals who are _actively participating_, and any _conduct_ that qualifies as _doxxing_ and _retaliating_.
